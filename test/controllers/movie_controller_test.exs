defmodule Ex1.MovieControllerTest do
  ...
  # JLF: Getting index template defined in movie_controller.ex
  ...
  # JLF: Getting *new* template defined in movie_controller.ex
  ...
  test "shows chosen resource", %{conn: conn} do
    movie = insert_movie()
  # JLF: Getting show template defined in movie_controller.ex
